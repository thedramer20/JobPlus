      ...
      <div className="container stack" style={{ gap: "1.5rem" }}>
        ...
        <div className="grid grid-3 jp-network-grid">
          ...
          <article className="surface jp-network-card jp-recruiter-bridges-card" style={{ gridColumn: "span 2" }}>
            ...
            {/* Recruiter List */}
            <motion.div className="stack" style={{ gap: "0.9rem", marginTop: "1rem" }} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45 }}>
          ...
          <article className="surface jp-network-card jp-suggested-connections-card">
            ...
            <motion.div className="stack" style={{ gap: "0.9rem", marginTop: "1rem" }} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45, delay: 0.1 }}>
              {suggestedConnectionsData.map((connection, index) => (
                <motion.div
                  key={connection.id}
                  className="jp-connection-item"
                ...
                >
                  ...
                  <div className="row" style={{ gap: "0.45rem", flexWrap: "wrap" }}>
                    <motion.button className="btn btn-secondary" type="button" whileHover={{ scale: 1.02 }} transition={{ duration: 0.16 }}>
                      Connect
                    </motion.button>
                    <motion.button className="btn btn-ghost" type="button" whileHover={{ scale: 1.02 }} transition={{ duration: 0.16 }}>
                      View profile
                    </motion.button>
                  </div>
        ...
        <AnimatePresence mode="wait">
          {selectedRecruiter ? (
            <motion.article
              className="surface jp-network-card jp-intro-script-card"

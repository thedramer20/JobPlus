    ...
    <div className="jp-home-root">
      <section className="section">
        <div className="container hero">
          <motion.div className="hero-panel stack" style={{ position: "relative", overflow: "hidden" }} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55, ease: "easeOut" }}>
            <motion.div
              className="jp-hero-particles"
            ...
            >
              {heroParticles.map((particle) => (
                <motion.span
                  ...
                  animate={{ opacity: [0.2, 0.65, 0.2], y: [0, -10, 0], scale: [1, 1.2, 1] }}
                  transition={{ duration: 3.6, ease: "easeInOut", repeat: Infinity, delay: particle.delay }}
                  style={{
                    position: "absolute",
                    left: particle.left,
                    top: particle.top,
                    ...
                    boxShadow: "0 0 35px rgba(109, 99, 255, 0.08)"
                  }}
                />
              ))}
            </motion.div>
            <span className="pill">For ambitious candidates and growth-stage employers</span>
            <div className="stack" style={{ gap: "0.8rem", position: "relative", zIndex: 1 }}>
              ...
              <p style={{ color: "var(--text-soft)", fontSize: "1.08rem", maxWidth: "60ch", position: "relative", zIndex: 1 }}>
                  ...
                  <div className="stack" style={{ gap: "0.75rem" }}>
                    ...
                    <div className="row" style={{ gap: "0.6rem" }}>
                      <motion.button
                        ...
                        animate={post.likedByCurrentUser ? { scale: [1, 1.14, 1] } : { scale: 1 }}
          ...
          <div className="grid grid-3">
            {jobsLoading ? (
              ...
              jobs.slice(0, 3).map((job, index) => (
                <motion.div key={job.id} initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.45, delay: index * 0.08 }}>
                  <JobCard job={job} />
                </motion.div>
              ))
            )}
